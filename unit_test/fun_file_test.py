...
class LoadFile(unittest.TestCase):
    ...
    normal_txt_file = 'validation_test/v2result_single_avg.csv'
    normal_npy_file = 'validation_test/sample_input_fb_numerous-lines_freq.npy'
    ...
    x_fb = 'validation_test/sample_input_fb_couple-of-lines_freq.dat'
    y_fb = 'validation_test/sample_input_fb_couple-of-lines_inten.npy'
    lo_fb = 'validation_test/sample_input_fb_couple-of-lines_lo.dat'

    def test_single_file_txt_fmt(self):
        print('\nTest single file loader')
        loaded = sp.load_single_file(self.y_single)
    ...
    def test_loader_single_y(self):
        ...
        args_list = [self.y_single, '-lo', self.lo_fb]
    ...
    def test_loader_single_npy(self):
        ...
        self.assertTrue(isinstance(loaded, np.ndarray))
        self.assertEqual(loaded.shape, (34,))
    ...
    def test_analyze_txt_fmt(self):
        ...
        print('\nTest valid comma delimited text with 1 header line')
        delm, hd, eof = sp.analyze_txt_fmt(self.normal_txt_file)
        self.assertEqual(delm, ',')
